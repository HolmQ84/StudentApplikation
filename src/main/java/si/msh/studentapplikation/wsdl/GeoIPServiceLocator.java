...
public class GeoIPServiceLocator extends org.apache.axis.client.Service implements si.msh.studentapplikation.wsdl.GeoIPService {
 ...
 */
    ...
    public si.msh.studentapplikation.wsdl.GeoIPServiceSoap_PortType getGeoIPServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            si.msh.studentapplikation.wsdl.GeoIPServiceSoap_BindingStub _stub = new si.msh.studentapplikation.wsdl.GeoIPServiceSoap_BindingStub(portAddress, this);
    ...
    public si.msh.studentapplikation.wsdl.GeoIPServiceSoap_PortType getGeoIPServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            si.msh.studentapplikation.wsdl.GeoIPServiceSoap12Stub _stub = new si.msh.studentapplikation.wsdl.GeoIPServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (si.msh.studentapplikation.wsdl.GeoIPServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                si.msh.studentapplikation.wsdl.GeoIPServiceSoap_BindingStub _stub = new si.msh.studentapplikation.wsdl.GeoIPServiceSoap_BindingStub(new java.net.URL(GeoIPServiceSoap_address), this);
                _stub.setPortName(getGeoIPServiceSoapWSDDServiceName());
                return _stub;
            }
            if (si.msh.studentapplikation.wsdl.GeoIPServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                si.msh.studentapplikation.wsdl.GeoIPServiceSoap12Stub _stub = new si.msh.studentapplikation.wsdl.GeoIPServiceSoap12Stub(new java.net.URL(GeoIPServiceSoap12_address), this);
                _stub.setPortName(getGeoIPServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
