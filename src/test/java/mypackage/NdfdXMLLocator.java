...
public class NdfdXMLLocator extends org.apache.axis.client.Service implements mypackage.NdfdXML {
    ...
    public mypackage.NdfdXMLPortType getndfdXMLPort() throws javax.xml.rpc.ServiceException {
    ...
    public mypackage.NdfdXMLPortType getndfdXMLPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.NdfdXMLBindingStub _stub = new mypackage.NdfdXMLBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.NdfdXMLPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.NdfdXMLBindingStub _stub = new mypackage.NdfdXMLBindingStub(new java.net.URL(ndfdXMLPort_address), this);
                _stub.setPortName(getndfdXMLPortWSDDServiceName());
                return _stub;
            }
        }
